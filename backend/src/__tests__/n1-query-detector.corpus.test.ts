 ...
 *
 * Every case here is distilled from real open-source code that was read by hand
 * and classified during a scan of 28 repositories. The MUST_DETECT cases come
